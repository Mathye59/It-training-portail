  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      <button
        ...
        type="button"
        className="absolute top-1/2 right-4 -translate-y-1/2 bg-cyanIT text-white rounded-full w-10 h-10 flex items-center justify-center shadow-md hover:scale-105 transition-transform"
      >
        🔍
      </button>
    </div>
